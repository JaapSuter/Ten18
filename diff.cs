diff --git a/Ten18.Build/Interop/TypeRefs.cs b/Ten18.Build/Interop/TypeRefs.cs
index 00f5b14..9baba41 100644
--- a/Ten18.Build/Interop/TypeRefs.cs
+++ b/Ten18.Build/Interop/TypeRefs.cs
@@ -19,18 +19,10 @@ namespace Ten18.Interop
 {
...
-
+        public static ModuleDefinition ManagedModuleDef { get; private set; }
+                
         public static int SizeOfVTableSlot { get; private set; }
         public static int SizeOfRegister { get; private set; }
         
@@ -39,103 +31,10 @@ namespace Ten18.Interop
...
-            
+            ManagedModuleDef = moduleDef;
+            NativeFactory = moduleDef.GetType("Ten18.Interop.NativeFactory");            
+            PInvokeModuleRef = new ModuleReference("Ten18.exe");            
