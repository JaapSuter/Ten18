...
namespace Ten18 { namespace Graphics {
    ...
    public:
        ...
        void Initialize(IDXGIAdapter2& dxgiAdapter2, IDXGIDevice2& dXGIDevice2, ID3D11Device1& d3D11Device1);
    ...
    private:
        ...
        IDXGIAdapter2*  mDXGIAdapter2;
        IDXGIDevice2*   mDXGIDevice1;
        ID3D11Device*   mD3D11Device1;
        
        COM::COMPtr<ID3D10Device1>              mD3D10Device1;
        COM::COMPtr<ID3D10Debug>                mD3D10Debug;
        COM::COMPtr<ID2D1Factory1>              mD2D1Factory1;
        COM::COMPtr<IDWriteFactory>             mDWriteFactory;
        COM::COMPtr<ID2D1Device>                mD2D1Device;
        COM::COMPtr<ID2D1DeviceContext>         mD2D1DeviceContext;
